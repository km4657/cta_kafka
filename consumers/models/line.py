...
class Line:
    ...
    def process_message(self, message):
        ...
        if 'transformed' in message.topic(): # Set the conditional correctly to the stations Faust Table
            logger.info('process_message: transformed')
            try:
